...
\begin{enumerate}
  ...
  \item Боря + Михаил Шнитке показывали и обсуждали видео от 3blue1brown. Про пи и комплексные числа, \url{}. Затем уже без комментариев,
  но с русскими субтитрами смотрели видео про гипотезу Римана, \url{}.
