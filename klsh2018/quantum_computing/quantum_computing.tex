...
\begin{problem}
Исходя из геометрического определения умножения, умножь $z=a+bi$ на $i$.
Почему $i^2=-1$?

Нарисуй геометрически умножение произвольного $z=a+bi$ на $3+4i$.
Почему $(3+4i)z = 3z + 4iz$?
...
\begin{enumerate}
  \item У комплексного числа $w = 3+4i$ найди $|w|$, $|w|^2$, $\Arg w$, $\Re w$, $\Im w$, $w^*$, $ww^*$.
  \item Найди $i^2$, $(1+i)^2$, $(1+i)/(1-i)$, $(3+5i) \cdot (3+3i)$;
