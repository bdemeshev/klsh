...
\begin{problem}
  Рассмотрим действие на паре кубит $A = \ketbra{0}{0} \otimes I + \ketbra{1}{1} \otimes X$.
  \begin{enumerate}
    \item Найди $A \cdot \ket{00}$, $A \cdot \ket{10}$, $A\cdot \ket{++}$;
    \item Что делает действие $A$?
  \end{enumerate}
\begin{sol}
  $A \cdot \ket{00} = \ket{00}$, $A \cdot \ket{10} = \ket{11}$.
\end{sol}
\end{problem}
...
\begin{problem}
  Запиши:
  \begin{enumerate}
    \item пару кубит $\ket{++}$ в стандартном базисе;
    \item пару кубит $\ket{+0}$ в стандартном базисе;
    \item пару кубит $\ket{00}$ в базисе $\ket{++}$, $\ket{--}$, $\ket{+-}$, $\ket{-+}$
  \end{enumerate}
  \begin{sol}
  \end{sol}
\end{problem}
...
\begin{problem}
  Запиши действие $CNOT = \ketbra{00}{00} + \ketbra{01}{01} + \ketbra{10}{11} + \ketbra{11}{10}$
  в базисе $\ket{++}$, $\ket{--}$, $\ket{+-}$, $\ket{-+}$.
  \begin{sol}
  \end{sol}
\end{problem}
...
\begin{problem}
  Рассмотрим диффузию $D = 2\ketbra{++}{++} - I^{\otimes 2}$.
  Найди $D\cdot \ket{00}$, $D\cdot \ket{10}$, $D\cdot \ket{++}$, $D^{-1}$.
  \begin{sol}
    $D\cdot \ket{00} = \frac{1}{2}(\ket{01} + \ket{10} + \ket{11} - \ket{00})$
  \end{sol}
\end{problem}
